...
namespace Arnet.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //заменить на AddArnet
            services.AddDbContext<ARNETContext>();
            services.AddScoped<AccountManager>();
            services.AddHttpContextAccessor();
            services.AddScoped<SignInManager>();
            services.AddScoped<AgencyManager>();
            services.AddScoped<InviteManager>();
            services.AddScoped<AgentManager>();
            services.AddScoped<ApartmentManager>();
            services.AddScoped<ReportCreator>();

            services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie();   //TODO: задать путь для авторизации
        }
