...
-- --------------------------------------------------
-- Date Created: 06/08/2020 03:01:38
-- Generated from EDMX file: C:\Users\vadim\OneDrive\Рабочий стол\HSE\КПО\Lab7_ArnetAdminApp\ArnetAdminApp.Data\LiteArnetModel.edmx
-- --------------------------------------------------
...
-- Creating non-clustered index for FOREIGN KEY 'FK_UserBan'
CREATE INDEX [IX_FK_UserBan]
ON [dbo].[Bans]
    ([User_Id]);
GO
