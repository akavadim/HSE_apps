...
public class AccountTests {
    ...
    public Object[][] WithdrawData(){
        ...
        fullAccount.deposit(1000000);

        blockedAccount.deposit(1000);
        blockedAccount.block();

        Object[][] res = new Object[][]{
                ///         Account, Withdraw, ExpectedBalance, ExpectedResult
                new Object[]{fullAccount, 1000000, 0, true},
    ...
    public Object[][] DepositData(){
        ...
        return  new Object[][]{
                ...
                //-----Аккаунт, depositSum, expectedBalance, expectedResult
                new Object[]{account, 0, 500, true},
                new Object[]{new Account(), 1000000, 1000000, true},
    ...
    public void BlockTest(){
        ...
        boolean actual1 = account.isBlocked();
        account.unblock();
        boolean actual2 = account.isBlocked();
